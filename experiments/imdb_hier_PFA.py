...
if __name__ == '__main__':
    sys.stdout = Logger('./logs/imdb/imdb_hier_out.log', sys.stdout)
    sys.stderr = Logger('./logs/imdb/imdb_hier_err.log', sys.stderr)
    variables_path = './variables.txt'
    root_path = '../storage/imdb/traces_data/hier'
    ...
    input_dim = 300
    max_length = 60000
    pfa_save_root = '../storage/imdb/pfa_construction/hier'
