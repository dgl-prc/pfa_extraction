...
def random_balanced_word(paratheses_depth):
    count = 0
    word = ""
    while len(word) < paratheses_depth:
...
def get_balanced_parantheses_train_set(n, short, longg, lengths=None, max_train_samples_per_length=300,
    ...
    return make_train_set_for_target(is_balanced_parantheses, alphabet_bp, lengths=lengths, \
